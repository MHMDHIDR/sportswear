...
export default function UsersControl() {
  ...
  const fetchUsers = () => {
    // In a real app, replace this with a fetch call to your API
    setUsers([
  ...
  return (
    <div className="p-4 md:p-10 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex flex-col gap-4">
